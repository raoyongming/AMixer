...
def get_args_parser():
    parser = argparse.ArgumentParser('AMixer training and evaluation script for image classification', add_help=False)
...
def main(args):
    ...
    gflops = calc_flops(model, args.input_size)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('AMixer training and evaluation script', parents=[get_args_parser()])
